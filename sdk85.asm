;        TITLE   ('SDK-85 MONITOR, VERSION 2.1, 1 NOVEMBER 1976')
;**********************************************************************
;
...
CMMND: 
        ...
        MVI     A,ADISP ; OUTPUT CONTROL CHARACTER TO USE ADDRESS FIELD 
...
CMD15:
        ...
        MOV     A,L     ; PUT LOW ORDER BYTE IN L
...
XCM15:
        MOV     A,M
        ORA     A       ; SET F/F'S
        JZ      XCM18   ; BRANCH IF AT EUD OF TABLE
        CPI     ','     ; NO - SEE IF COMMA
        JNZ     GETCM   ; NO - MUST BE CARRIAGE RETURN TO END COMMAND
XCM18:
        PUSH    H       ; PUT POINTER ON STACK
        MOV     E,M
        MVI     D,RAMST SHR 8 ; FETCH ADDRESS OF SAVE LOCATION FROM
        INX     H       ; /TABLE
...
REG10: 
        ...
        MVI     D,RAMST SHR 8 ; PUT MSP OF SAVE LOC ADDRESS INTO 0 
